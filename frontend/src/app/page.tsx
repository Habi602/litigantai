...
export default function Home() {
  return (
    <div className="min-h-screen bg-slate-950 text-white">
      ...
      <nav className="sticky top-0 z-50 bg-slate-950/80 backdrop-blur-lg border-b border-white/10">
        <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
          <Link href="/" className="flex items-center gap-2">
            ...
            <span className="text-lg font-semibold tracking-tight">NoahLaw</span>
          </Link>
          <div className="flex items-center gap-8">
            ...
            <Link
              href="/login"
              className="text-sm font-medium border border-white/20 text-white px-4 py-2 rounded-lg hover:bg-white/10 transition-colors"
            >
              Sign In
            </Link>
          </div>
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto text-center px-6 pt-32 pb-24">
          <div className="inline-flex items-center gap-2 bg-white/5 border border-white/10 rounded-full px-4 py-1.5 mb-8">
            ...
            <span className="text-xs text-slate-400 tracking-wide uppercase">AI-Powered Legal Platform</span>
          </div>

          <h1 className="text-6xl font-bold tracking-tight leading-tight mb-6">
            Navigate the law<br />
            with <span className="text-amber-400">confidence</span>
          </h1>
          ...
          <div className="flex items-center justify-center gap-4">
            <Link
              href="/login"
              className="inline-flex items-center gap-2 bg-amber-500 text-slate-950 font-semibold text-lg px-8 py-3.5 rounded-lg hover:bg-amber-400 transition-colors"
            >
              Get Started
        ...
        <div className="border-y border-white/10 bg-white/[0.02]">
          <div className="max-w-5xl mx-auto grid grid-cols-3 divide-x divide-white/10">
            <div className="py-8 text-center">
              ...
              <p className="text-sm text-slate-500 mt-1">Cases Managed</p>
            </div>
            <div className="py-8 text-center">
              <p className="text-3xl font-bold text-white">500+</p>
              <p className="text-sm text-slate-500 mt-1">Legal Specialists</p>
            </div>
            <div className="py-8 text-center">
      ...
      {/* Mission Section */}
      <section id="mission" className="py-24 px-6 scroll-mt-16">
        <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-16 items-center">
          <div>
            <p className="text-sm font-medium text-amber-400 uppercase tracking-wide mb-4">Our Mission</p>
          ...
          <div className="bg-gradient-to-br from-slate-800 to-slate-900 border border-white/10 rounded-2xl p-10">
      ...
      {/* Features Section */}
      <section id="features" className="py-24 px-6 bg-white/[0.02] border-y border-white/10 scroll-mt-16">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-16">
            <p className="text-sm font-medium text-amber-400 uppercase tracking-wide mb-4">Features</p>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-slate-900 border border-white/10 rounded-xl p-8 hover:border-white/20 transition-colors">
              ...
              <h3 className="text-lg font-semibold mb-2">AI Case Analysis</h3>
            ...
            <div className="bg-slate-900 border border-white/10 rounded-xl p-8 hover:border-white/20 transition-colors">
              <div className="w-12 h-12 rounded-lg bg-rose-500/10 flex items-center justify-center mb-5">
                <svg className="w-6 h-6 text-rose-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M19.5 14.25v-2.625a3.375 3.375 0 00-3.375-3.375h-1.5A1.125 1.125 0 0113.5 7.125v-1.5a3.375 3.375 0 00-3.375-3.375H8.25m2.25 0H5.625c-.621 0-1.125.504-1.125 1.125v17.25c0 .621.504 1.125 1.125 1.125h12.75c.621 0 1.125-.504 1.125-1.125V11.25a9 9 0 00-9-9z" />
                </svg>
              </div>
              <h3 className="text-lg font-semibold mb-2">Document Builder</h3>
              <p className="text-sm text-slate-400 leading-relaxed">
            ...
            <div className="bg-slate-900 border border-white/10 rounded-xl p-8 hover:border-white/20 transition-colors">
              ...
              <h3 className="text-lg font-semibold mb-2">AI Legal Chat</h3>
              <p className="text-sm text-slate-400 leading-relaxed">
      ...
      <section id="how-it-works" className="py-24 px-6 scroll-mt-16">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-16">
            <p className="text-sm font-medium text-amber-400 uppercase tracking-wide mb-4">How It Works</p>
            <h2 className="text-4xl font-bold tracking-tight">
          ...
          <div className="grid md:grid-cols-3 gap-12">
            <div className="text-center">
              ...
              <h3 className="text-lg font-semibold mb-3">Create Your Case</h3>
              <p className="text-sm text-slate-400 leading-relaxed">
            ...
            <div className="text-center">
              ...
              <h3 className="text-lg font-semibold mb-3">Build Your Strategy</h3>
              <p className="text-sm text-slate-400 leading-relaxed">
            ...
            <div className="text-center">
              ...
              <h3 className="text-lg font-semibold mb-3">Get Expert Help</h3>
              <p className="text-sm text-slate-400 leading-relaxed">
